...
class ImageModuleBoundaryTest {

    @Test
    fun `image module does not depend on mirai sending or business modules`() {
        val forbidden = listOf(
            ...
            "cn.chahuyun.economy.repository",
            "cn.chahuyun.economy.proxy"
        )
    ...
    private fun assertNoForbiddenText(roots: List<Path>, forbidden: List<String>) {
        ...
        assertTrue(hits.isEmpty(), "image boundary violations:\n${hits.joinToString("\n")}")
    }
}
